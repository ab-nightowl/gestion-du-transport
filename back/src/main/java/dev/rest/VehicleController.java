...
public class VehicleController {
	...
	public void initDateVehicle() {
		Vehicle v1 = new Vehicle("Abc123", "Mercedes", "Model1", "categ1", "../statique/img/car1.png", 4,
				VehicleStatus.REPARATION);
		Vehicle v2 = new Vehicle("Abc456", "Audi", "Model1", "categ2", "../statique/img/car2.png", 2,
				VehicleStatus.OUTOFORDER);
		Vehicle v3 = new Vehicle("Abc789", "Toyota", "Model1", "categ3", "../statique/img/car3.jpg", 6,
				VehicleStatus.SERVICE);
		Vehicle v4 = new Vehicle("Abc999", "Mercedes", "Model1", "categ4", "../statique/img/car4.png", 1,
				VehicleStatus.OUTOFORDER);
